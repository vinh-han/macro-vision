...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/dishes/suggestion": {
            "post": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dishes.SuggestDishesParam"
                        }
                    },
                    {
                        "type": "string",
                ...
                "responses": {
                    "200": {
                        "description": "dish suggestions",
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/dishes.SuggestedDish"
                            }
                        }
                    },
                    "400": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/handlers.CheckFavoritedDishResponse"
                        }
                    },
                    "400": {
    ...
    "definitions": {
        ...
        "handlers.CheckFavoritedDishResponse": {
            "type": "object",
            "properties": {
                "favorited": {
                    "type": "string"
